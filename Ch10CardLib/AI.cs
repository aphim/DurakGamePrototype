    ...
    public class AI : Player
    {
        ...
        public int AITurnCycle(Card TrumpCard, Field PlayingField, string round, bool perevodnoyFlag, bool gameOver)
        {
            ...
            if(gameOver == false)
            {
                ...
                {
                    return AIAttackerInitialTurn(TrumpCard, gameOver);
                }
                else if (round == ATTACKERTURN)
                {
                    return AIAttackerTurn(PlayingField, TrumpCard, gameOver);
                }
                else if (round == DEFENDERTURN)
                {
                    return AIDefenderTurn(PlayingField, TrumpCard, perevodnoyFlag, gameOver);
                }
                else
                {
                    return TURNSKIPPED;
        ...
        /// <param name="trumpCard"></param>
        public int AIAttackerInitialTurn(Card trumpCard, bool gameOver)
        {
        ...
        /// <param name="trumpCard"></param>
        /// <param name="handAI"></param>
        public int AIAttackerTurn(Field playingField, Card trumpCard, bool gameOver)
        {
            if (gameOver == false)
            {
        ...
        /// <param name="trumpCard"></param>
        /// <param name="passFlag"></param>
        public int AIDefenderTurn(Field playingField, Card trumpCard, bool perevodnoyFlag, bool gameOver)
        {
            if (gameOver == false)
            {
